...
const frontendMock={
  tasks: {
    ...
    "task-4": {
      ...
      description:
        "Add functionality to rearrange tasks between columns using React DnD.",
      createdAt: new Date().toISOString(),
      updatedAt: new Date().toISOString(),
    },
    "task-5": {
      ...
      description:
        "Implement login, signup, and logout using JWT and refresh tokens.",
      createdAt: new Date().toISOString(),
      updatedAt: new Date().toISOString(),
    },
    "task-6": {
    ...
    "task-8": {
      ...
      title: "Polish UI",
      description:
        "Improve styling with TailwindCSS, add responsive design, and dark mode.",
      createdAt: new Date().toISOString(),
      updatedAt: new Date().toISOString(),
    },
  },
